...
- Payment failures (StoreKit product/purchase errors, backend receipt verification, Stripe errors) are now reported to Sentry so handled payment errors are visible in monitoring.
