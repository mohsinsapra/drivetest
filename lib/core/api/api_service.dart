    ...
    try {
      ...
      if (data is Map<String, dynamic>) {
        ...
        try {
          ...
          if (data['show_legacy_tests'] != null) merged['show_legacy_tests'] = data['show_legacy_tests'];
          if (data['show_bcd_tests'] != null) merged['show_bcd_tests'] = data['show_bcd_tests'];
          if (data['is_administrator'] != null) merged['is_administrator'] = data['is_administrator'];
