...
class TranslationsSv implements Translations {
  ...
  String get auth_welcome_subtitle =>
      'Öva och förbered dig inför dina körprov!';
  @override
  ...
  @override
  String get auth_username => 'Användarnamn';
  @override
  ...
  @override
  String get auth_val_username_required => 'Vänligen ange ett användarnamn';
  @override
  ...
  dynamic _flatMapFunction(String path) {
    switch (path) {
      ...
      case 'auth_welcome_subtitle':
        return 'Öva och förbered dig inför dina körprov!';
      case 'auth_login_btn':
        return 'LOGGA IN';
      ...
      case 'auth_val_username_required':
        return 'Vänligen ange ett användarnamn';
