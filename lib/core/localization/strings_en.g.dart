...
class Translations implements BaseTranslations<AppLocale, Translations> {
	...
	String get profile_receipt_footer => 'Keep this receipt for your records. Contact support with your receipt number if you have questions about this purchase.';
	...
	String get checklist_language_subtitle => 'Translate checklist to your language';
	...
	String get iap_owned_by_other_body => 'This subscription is associated with a different account. Please log in with the account you originally purchased it on.';
	...
	String notif_morning_title_exam({required Object examTitle}) => '☀️ Time to study ${examTitle}';
	String get notif_morning_body => 'Start your practice session — build that streak!';
	String get notif_evening_title => '🌙 Evening streak check-in';
	String notif_evening_title_exam({required Object examTitle}) => '🌙 ${examTitle} is waiting for you';
	String get notif_evening_body => 'Don\'t let today slip by — keep your streak alive!';
	String notif_activity_0({required Object examTitle}) => 'You were working on ${examTitle} — one more session and it clicks.';
	String notif_activity_1({required Object examTitle}) => '${examTitle} is waiting. Your last session built real momentum — don\'t lose it.';
	String notif_activity_2({required Object examTitle}) => 'Small daily sessions beat cramming. Jump back into ${examTitle} now.';
	String notif_activity_3({required Object examTitle}) => 'You\'re closer than you think on ${examTitle}. Keep the streak alive!';
	String notif_activity_4({required Object examTitle}) => 'One focused session on ${examTitle} today makes the exam day easier.';
	...
	String get tut_step1b_body => 'Tap \'Question Language\' in the menu, then select a language from the list.';
	String get tut_step1_grid_hint => 'Select a different language below, for example English.';
	...
	String get tut_complete_body => 'Great job! You now know how to translate questions and peek at the original text.';
	...
	String get onb_pre_purchase_subtitle => 'Create a free account to access your subscription on all your devices, or continue as a guest — you can always create one later.';
	...
	String get auth_guest_session_error => 'Could not restore your session. Please try again.';
	...
	String get delete_account_confirm_body => 'This action is permanent and cannot be undone. All your progress and data will be removed.';
	...
	String get home_delete_progress_body => 'Are you sure you want to delete this saved test?';
	String get home_delete_all_tests_title => 'Delete All Tests';
	String get home_delete_all_tests_body => 'Are you sure you want to delete all test attempts?';
	...
	String get test_save_backend_failed => 'Progress was saved on this device, but sync to your account failed. Please try again.';
	String get test_feedback_unavailable => 'Feedback is unavailable for this question.';
	...
	String get test_feedback_hint => 'Tell us what is wrong with this question...';
	String get test_feedback_submitted => 'Thanks! Your feedback was submitted.';
	String get test_feedback_failed => 'Could not submit feedback. Please try again.';
	...
	String get test_question_language_subtitle => 'Translate questions to your language';
	...
	String get test_finish_unanswered_prompt => 'You have {count} unanswered question(s). Do you still want to finish the test?';
	...
	String get test_result_fail_message => 'Keep practicing and try again. You can do it!';
	...
	String get test_result_need_to_pass => 'Keep practicing. You need {score}% to pass.';
	...
	String get error_too_many_requests => 'Too many attempts. Please try again in {wait}.';
	String get error_service_unavailable => 'Service temporarily unavailable. Please try again in a moment.';
	String get error_connection_timeout => 'Connection timed out. Check your internet and try again.';
	String get error_session_expired => 'Your session has expired. Please log in again.';
	String get error_logged_out_other_device => 'You were logged out because your account was used on another device.';
	String get app_download_title => 'Better on the app';
	String get app_download_subtitle_android => 'Download the Drive Test app on Google Play for a faster, smoother experience.';
	String get app_download_subtitle_ios => 'Download the Drive Test app on the App Store for a faster, smoother experience.';
	...
	String get journey_group_stage_progress => 'Group {group} — Stage {done} / {total}';
	...
	String get journey_correct_toward_mastery => 'Correct! ({count}/3 toward mastery)';
	...
	String get journey_questions_not_ready => 'Questions not loaded yet. Please wait.';
	...
	String get journey_review_unlocked_msg => 'All questions mastered. The Full Test is now unlocked!';
	...
	String get ai_greeting => 'Hi! What would you like to know about this question?';
	...
	String get ai_greeting_full => 'Need help with this question? Pick one of the options below, or ask your own question.';
	...
	String get smart_learning_subtitle => 'Train chunk by chunk, master your weak spots';
	...
	String smart_review_subtitle({required Object count}) => '${count} questions · All previous parts';
	...
	String get smart_hearts_guide_body => 'Each wrong answer costs a heart ❤️. Lose all 3 and you\'ll be taken back — complete the earlier parts to unlock the full exam.';
	...
	String smart_result_weak_updated({required Object count}) => '${count} weak questions updated';
	...
	String smart_category_mistakes_subtitle({required Object count, required Object questionLabel}) => '${count} ${questionLabel} to review across this category';
	String get smart_category_question => 'question';
	String get smart_category_questions => 'questions';
	String smart_result_unlock_needed({required Object count}) => 'Master ${count} questions to unlock the full exam.';
	String smart_result_unlock_remaining({required Object count, required Object questionLabel}) => '${count} more ${questionLabel} to master and you\'ll unlock the full exam.';
	...
	String smart_mastered_of({required Object mastered, required Object total}) => '${mastered} / ${total} mastered';
...
extension on Translations {
	dynamic _flatMapFunction(String path) {
		switch (path) {
			...
			case 'profile_view_profile': return 'View Profile';
			case 'profile_edit': return 'Edit profile';
			case 'profile_section_preferences': return 'Preferences';
			case 'profile_section_resources': return 'Resources';
			case 'profile_stats': return 'My stats';
			case 'profile_statistics': return 'Statistics';
			case 'stats_no_tests_yet': return 'No completed tests yet';
			case 'stats_attempt_history': return 'ATTEMPT HISTORY';
			case 'stats_avg_time': return 'Avg time';
			case 'stats_attempt_one': return 'attempt';
			case 'stats_attempt_many': return 'attempts';
			case 'stats_avg_label': return 'Avg';
			case 'stats_unknown': return 'Unknown';
			case 'stats_best': return 'Best';
			case 'stats_average': return 'Average';
			case 'home_attempt_details': return 'Attempt Details';
			case 'home_saved_questions_title': return 'Saved Questions';
			...
			case 'profile_receipt_title': return 'Receipt';
			case 'profile_receipt_copy_number': return 'Copy receipt number';
			case 'profile_receipt_number_copied': return 'Receipt number copied';
			case 'profile_no_purchases': return 'No purchases yet.';
			case 'profile_receipt_payment_receipt': return 'Payment Receipt';
			case 'profile_receipt_no': return 'Receipt no.';
			case 'profile_receipt_product': return 'Product';
			case 'profile_receipt_duration': return 'Duration';
			case 'profile_receipt_amount_paid': return 'Amount paid';
			case 'profile_receipt_payment_via': return 'Payment via';
			case 'profile_receipt_via_iap': return 'Apple App Store';
			case 'profile_receipt_via_card': return 'Card (Stripe)';
			case 'profile_receipt_transaction_id': return 'Transaction ID';
			case 'profile_receipt_payment_intent': return 'Payment intent';
			case 'profile_receipt_reference_no': return 'Reference no.';
			case 'profile_receipt_footer': return 'Keep this receipt for your records. Contact support with your receipt number if you have questions about this purchase.';
			...
			case 'home_started': return 'Started';
			...
			case 'home_quick_access': return 'Quick Access';
			case 'home_qa_start_test': return 'Practice Test';
			case 'home_qa_custom_test': return 'Custom Test';
			case 'home_qa_saved_questions': return 'Saved Questions';
			case 'home_qa_settings': return 'Settings';
			...
			case 'auth_feedback_payment_issue': return 'Payment issue';
			...
			case 'auth_express_google': return 'Continue with Google';
			case 'auth_google_label': return 'Google';
			case 'auth_express_apple': return 'Continue with Apple';
			case 'auth_more_options': return 'More options';
			...
			case 'auth_apple_connecting': return 'Connecting to Apple...';
			...
			case 'auth_reset_onboarding_tooltip': return 'Reset Onboarding';
			case 'auth_language_english': return 'English';
			case 'auth_language_swedish': return 'Swedish';
			...
			case 'checklist_language_subtitle': return 'Translate checklist to your language';
			...
			case 'legal_terms_of_use': return 'Terms of Use';
			case 'legal_privacy_policy': return 'Privacy Policy';
			case 'bcd_buy': return 'Buy';
			case 'bcd_payment_failed': return 'Payment failed. Please try again.';
			case 'iap_owned_by_other_title': return 'Subscription Already Linked';
			case 'iap_owned_by_other_body': return 'This subscription is associated with a different account. Please log in with the account you originally purchased it on.';
			...
			case 'bcd_expired_label': return 'Expired';
			case 'bcd_sub_expires_days': return 'Expires in {days} days · {date}';
			...
			case 'bcd_tap_to_zoom': return 'Tap to zoom';
			...
			case 'smart_check': return 'Check';
			case 'notif_subtitle': return 'DriveTest';
			case 'notif_morning_title': return '☀️ Morning study reminder';
			case 'notif_morning_title_exam': return ({required Object examTitle}) => '☀️ Time to study ${examTitle}';
			case 'notif_morning_body': return 'Start your practice session — build that streak!';
			case 'notif_evening_title': return '🌙 Evening streak check-in';
			case 'notif_evening_title_exam': return ({required Object examTitle}) => '🌙 ${examTitle} is waiting for you';
			case 'notif_evening_body': return 'Don\'t let today slip by — keep your streak alive!';
			case 'notif_activity_0': return ({required Object examTitle}) => 'You were working on ${examTitle} — one more session and it clicks.';
			case 'notif_activity_1': return ({required Object examTitle}) => '${examTitle} is waiting. Your last session built real momentum — don\'t lose it.';
			case 'notif_activity_2': return ({required Object examTitle}) => 'Small daily sessions beat cramming. Jump back into ${examTitle} now.';
			case 'notif_activity_3': return ({required Object examTitle}) => 'You\'re closer than you think on ${examTitle}. Keep the streak alive!';
			case 'notif_activity_4': return ({required Object examTitle}) => 'One focused session on ${examTitle} today makes the exam day easier.';
			...
			case 'dash_chunks_mastered': return 'Chunks Mastered';
			case 'dash_weak_questions': return 'Weak Questions';
			...
			case 'onb_weekday_wed_short': return 'W';
			case 'onb_weekday_thu_short': return 'T';
			case 'onb_weekday_fri_short': return 'F';
			case 'onb_weekday_sat_short': return 'S';
			...
			case 'dash_recently_practiced': return 'Recent';
			case 'dash_exam_progress': return 'Exam Progress';
			case 'dash_cat_complete': return 'Complete';
			case 'dash_cat_not_started': return 'Not started';
			case 'dash_cat_almost_done': return '{n} left to finish!';
			case 'dash_cat_needs_practice': return 'Needs practice';
			case 'dash_cat_in_progress': return '{done}/{total} done';
			case 'dash_progress_all_done': return 'All topics complete!';
			case 'dash_progress_topics_done': return '{done} of {total} topics done';
			case 'dash_progress_avg_hint': return '{score}% overall avg';
			case 'dash_progress_no_attempts': return 'No attempts yet';
			case 'dash_smart_new': return 'New';
			case 'dash_quick_access': return 'Quick Access';
			case 'dash_item_one': return '1 item';
			case 'dash_item_many': return '{n} items';
			case 'dash_shortcuts_count': return '{n} shortcuts';
			case 'dash_loading_batch': return 'Batch {n}';
			case 'dash_loading_category': return 'Category {n}';
			case 'dash_no_exams_found': return 'No exams found.';
			case 'dash_card_active': return 'ACTIVE';
			case 'dash_card_inactive': return 'INACTIVE';
			case 'dash_card_expired': return 'Expired {date}';
			case 'dash_card_expires_today': return 'Expires today';
			case 'dash_card_expires_tomorrow': return 'Expires tomorrow';
			case 'dash_card_expires_days': return 'Expires in {days} days';
			case 'dash_card_expires_on': return 'Expires {date}';
			case 'dash_stat_completed': return 'Done';
			case 'dash_stat_none_yet': return 'None yet';
			case 'dash_stat_of_n': return 'of {total}';
			case 'dash_stat_to_train': return 'to train';
			case 'dash_stat_per_session': return 'Per session';
			case 'dash_perf_title1': return 'Performance';
			case 'dash_perf_title2': return 'Overview';
			case 'dash_period_today': return 'Today';
			case 'dash_period_7days': return '7 Days';
			case 'dash_period_all': return 'All Time';
			case 'dash_perf_subtitle': return 'Track your progress. Reach your goals.';
			case 'dash_perf_attempts_desc': return 'All your attempts in this period';
			case 'dash_perf_batches_desc': return 'Progress this period';
			case 'dash_avg_time_per_session': return 'Avg. Time / Session';
			case 'dash_perf_time_desc': return 'Average time taken per session';
			case 'dash_keep_it_up': return 'Keep it up!';
			case 'dash_consistency_today': return 'Consistency today, success tomorrow.';
			...
			case 'dash_new_test': return '+ New Test';
			case 'dash_no_attempts_yet': return 'No attempts yet';
			case 'dash_previous_attempts': return 'Previous attempts';
			case 'dash_see_all': return 'See all';
			case 'dash_all_attempts': return 'All Attempts';
			case 'tut_step1_title': return 'Step 1 of 2 — Translate';
			case 'tut_step1_body': return 'Tap the language button to open the list, then select English (or any other language).';
			case 'tut_step1b_title': return 'Step 1 of 2 — Choose a language';
			case 'tut_step1b_body': return 'Tap \'Question Language\' in the menu, then select a language from the list.';
			case 'tut_step1_grid_hint': return 'Select a different language below, for example English.';
			case 'tut_step2a_title': return 'Step 2 of 2 — Peek original';
			...
			case 'tut_step2b_title': return 'Step 2 of 2 — Now release';
			...
			case 'tut_complete_body': return 'Great job! You now know how to translate questions and peek at the original text.';
			...
			case 'onb_feature_ai_tutor': return 'Personal AI study coach';
			...
			case 'onb_duration_year_access': return '{n} year access';
			case 'onb_duration_months_access': return '{n} months access';
			case 'onb_duration_one_day': return '1 day';
			case 'onb_duration_days': return '{n} days';
			...
			case 'onb_pre_purchase_title': return 'One quick step';
			case 'onb_pre_purchase_subtitle': return 'Create a free account to access your subscription on all your devices, or continue as a guest — you can always create one later.';
			case 'onb_pre_purchase_sign_in': return 'Sign In / Create Account';
			case 'onb_pre_purchase_guest': return 'Continue as Guest';
			case 'auth_continue_as_guest': return 'Continue as Guest';
			case 'auth_guest_session_error': return 'Could not restore your session. Please try again.';
			...
			case 'btn_save_changes': return 'Save Changes';
			case 'btn_set_password': return 'Set Password';
			case 'btn_delete_account': return 'Delete My Account';
			case 'delete_account_confirm_body': return 'This action is permanent and cannot be undone. All your progress and data will be removed.';
			case 'btn_deleting': return 'Deleting...';
			case 'btn_keep_going': return 'Keep Going';
			case 'btn_exit': return 'Exit';
			case 'btn_save_and_exit': return 'Save & Exit';
			case 'btn_submit': return 'Submit';
			case 'btn_start_saved_test': return 'Start Saved Questions Test';
			case 'btn_buy_now': return 'Buy Now';
			case 'btn_pay_now': return 'Pay Now';
			case 'home_all_tests_deleted': return 'All tests have been deleted.';
			case 'home_delete_progress_title': return 'Delete Progress';
			case 'home_delete_progress_body': return 'Are you sure you want to delete this saved test?';
			case 'home_delete_all_tests_title': return 'Delete All Tests';
			case 'home_delete_all_tests_body': return 'Are you sure you want to delete all test attempts?';
			case 'test_time_up_submitting': return 'Time is up! Submitting your test.';
			case 'test_first_question': return 'This is the first question!';
			case 'test_exit_title': return 'Exit Test';
			case 'test_exit_save_prompt': return 'Would you like to save your progress?';
			case 'test_save_backend_failed': return 'Progress was saved on this device, but sync to your account failed. Please try again.';
			case 'test_feedback_unavailable': return 'Feedback is unavailable for this question.';
			case 'test_feedback_title': return 'Feedback';
			case 'test_feedback_type': return 'Type';
			case 'test_feedback_question_issue': return 'Question issue';
			case 'test_feedback_wrong_answer': return 'Wrong answer';
			case 'test_feedback_typo': return 'Typo/text issue';
			case 'test_feedback_image_issue': return 'Image issue';
			case 'test_feedback_other': return 'Other';
			case 'test_feedback_hint': return 'Tell us what is wrong with this question...';
			case 'test_feedback_submitted': return 'Thanks! Your feedback was submitted.';
			case 'test_feedback_failed': return 'Could not submit feedback. Please try again.';
			case 'test_translation_failed': return 'Translation failed. Please try again.';
			case 'test_language_english': return 'English';
			case 'test_language_swedish': return 'Svenska';
			case 'test_question_language_title': return 'Question Language';
			case 'test_question_language_subtitle': return 'Translate questions to your language';
			case 'test_question_language_menu': return 'Question Language';
			case 'test_turn_off_timer': return 'Turn off timer';
			case 'test_turn_on_timer': return 'Turn on timer';
			case 'test_turn_off_instant_marking': return 'Turn off instant marking';
			case 'test_turn_on_instant_marking': return 'Turn on instant marking';
			case 'test_question_saved': return 'Question saved';
			case 'test_question_removed': return 'Question removed from saved';
			case 'test_saved': return 'Saved';
			case 'test_save_question': return 'Save question';
			case 'test_questions_title': return 'Questions';
			case 'test_question_progress': return '{current} of {total}';
			case 'test_question_label': return 'Question {n}';
			case 'test_answered': return 'Answered';
			case 'test_not_answered': return 'Not answered';
			case 'test_finish_title': return 'Finish Test';
			case 'test_finish_unanswered_prompt': return 'You have {count} unanswered question(s). Do you still want to finish the test?';
			case 'test_finish_prompt': return 'Do you want to finish the test?';
			case 'test_finish_no': return 'No';
			case 'test_finish_yes': return 'Yes';
			case 'test_result_congratulations': return 'Congratulations!';
			case 'test_result_not_quite_there': return 'Not Quite There';
			case 'test_result_passed_badge': return 'PASSED';
			case 'test_result_failed_badge': return 'FAILED';
			case 'test_result_pass_message': return 'You have passed the test. Well done!';
			case 'test_result_fail_message': return 'Keep practicing and try again. You can do it!';
			case 'test_result_go_back': return 'Go Back';
			case 'test_result_see_results': return 'See Results';
			case 'test_result_screen_passed_title': return 'Test Passed';
			case 'test_result_screen_failed_title': return 'Test Failed';
			case 'test_result_question_review': return 'Question Review';
			case 'test_result_score_label': return 'Score';
			case 'test_result_passed_message': return 'Great job! You passed the test.';
			case 'test_result_need_to_pass': return 'Keep practicing. You need {score}% to pass.';
			case 'test_result_correct': return 'Correct';
			case 'test_result_wrong': return 'Wrong';
			case 'test_result_skipped': return 'Skipped';
			case 'test_result_above_pass_mark': return '{gap}% above pass mark';
			case 'test_result_below_pass_mark': return '{gap}% below pass mark';
			case 'test_result_your_results': return 'Your Results';
			case 'test_result_your_score': return 'Your score';
			case 'test_result_pass_mark': return 'Pass mark';
			case 'test_result_correct_answers': return 'Correct answers';
			case 'test_result_wrong_answers': return 'Wrong answers';
			case 'test_result_question_row': return 'Q{n}: {text}';
			case 'test_result_your_answer': return 'Your answer: {answer}';
			case 'error_too_many_requests': return 'Too many attempts. Please try again in {wait}.';
			case 'error_service_unavailable': return 'Service temporarily unavailable. Please try again in a moment.';
			case 'error_connection_timeout': return 'Connection timed out. Check your internet and try again.';
			case 'error_session_expired': return 'Your session has expired. Please log in again.';
			case 'error_logged_out_other_device': return 'You were logged out because your account was used on another device.';
			case 'app_download_title': return 'Better on the app';
			case 'app_download_subtitle_android': return 'Download the Drive Test app on Google Play for a faster, smoother experience.';
			case 'app_download_subtitle_ios': return 'Download the Drive Test app on the App Store for a faster, smoother experience.';
			case 'app_download_cta_android': return 'Download on Google Play';
			case 'app_download_cta_ios': return 'Download on the App Store';
			case 'app_download_learn_more': return 'Learn more at drivetest.se';
			case 'app_download_dismiss': return 'Continue in browser';
			case 'journey_title': return 'Learning Journey';
			case 'journey_start': return 'Start';
			case 'journey_continue': return 'Continue';
			case 'journey_start_subtitle': return 'Start your guided learning journey';
			case 'journey_complete': return 'Journey complete!';
			case 'journey_overall_progress': return 'Overall Progress';
			case 'journey_stages': return 'Stages';
			case 'journey_stage_n': return 'Stage {n}';
			case 'journey_stage_locked': return 'Complete previous stage to unlock';
			case 'journey_stages_to_unlock_review': return 'Complete all stages to unlock';
			case 'journey_review_mode': return 'Review Mode';
			case 'journey_review_locked': return 'Complete Review Mode to unlock';
			case 'journey_mastered_count': return '{done} / {total} mastered';
			case 'journey_review_count': return '{count} questions to review';
			case 'journey_all_mastered': return 'All questions mastered!';
			case 'journey_full_test_n': return 'Full {n}-Question Test';
			case 'journey_test_all': return 'Test all questions from this group';
			case 'node_group_prefix': return 'Group';
			case 'journey_passed_score': return 'Passed! Score: {score}%';
			case 'journey_stage_complete_title': return 'Stage {n} Complete!';
			case 'journey_review_complete_title': return 'Review Complete!';
			case 'journey_full_test_unlocked': return 'Full test ready';
			case 'journey_review_ready': return 'Review mode ready';
			case 'journey_all_groups_done': return 'All groups done — Mega Review';
			case 'journey_group_stage_progress': return 'Group {group} — Stage {done} / {total}';
			case 'journey_group_full_test_ready': return 'Group {group} — Full test ready';
			case 'journey_group_review_ready': return 'Group {group} — Review mode ready';
			case 'journey_loading_questions': return 'Loading questions…';
			case 'journey_group_unlocked': return 'Group {n} unlocked!';
			case 'journey_all_groups_complete': return 'All groups done!';
			case 'journey_group_complete': return 'Group {n} complete!';
			case 'journey_state_mastered': return 'Mastered';
			case 'journey_state_review': return 'Review';
			case 'journey_state_repeat': return 'Repeat soon';
			case 'journey_state_correct': return 'Correct';
			case 'journey_state_practiced': return 'Practiced';
			case 'journey_correct_toward_mastery': return 'Correct! ({count}/3 toward mastery)';
			case 'journey_try_again': return 'Try again — progress reset';
			case 'journey_failed_load': return 'Failed to load journey';
			case 'journey_retry': return 'Retry';
			case 'journey_questions_not_ready': return 'Questions not loaded yet. Please wait.';
			case 'journey_mastered_label': return 'Mastered';
			case 'journey_needs_review_label': return 'Needs Review';
			case 'journey_total_label': return 'Total';
			case 'journey_review_unlocked_msg': return 'All questions mastered. The Full Test is now unlocked!';
			case 'journey_back_to_group': return 'Back to Group';
			case 'journey_no_review_questions': return 'No questions to review!';
			case 'question_tab_label': return 'Tab';
			case 'bcd_min_label': return 'min';
			case 'ai_assistant': return 'AI Assistant';
			case 'ai_greeting': return 'Hi! What would you like to know about this question?';
			case 'ai_initializing': return 'Initializing AI...';
			case 'ai_input_hint': return 'Ask a question...';
			case 'ai_error': return 'Something went wrong. Please try again.';
			case 'ai_tooltip': return 'AI Assistant';
			case 'ai_hint_button': return 'Give me a hint';
			case 'ai_understand_button': return 'Help me understand this';
			case 'ai_continue_button': return 'Continue chat';
			case 'ai_greeting_full': return 'Need help with this question? Pick one of the options below, or ask your own question.';
			case 'ai_read_aloud': return 'Read aloud';
			case 'option_image_unavailable': return 'Image not available';
			case 'ai_close': return 'Close';
			case 'smart_learning_title': return 'Smart Learning';
			case 'smart_learning_subtitle': return 'Train chunk by chunk, master your weak spots';
			case 'smart_chunk_n': return ({required Object n}) => 'Part ${n}';
			case 'smart_chunk_passed': return 'Passed';
			case 'smart_chunk_locked': return 'Locked';
			case 'smart_chunk_active': return 'Start';
			case 'smart_chunk_retry': return 'Retry';
			case 'smart_review_n': return 'Review';
			case 'smart_review_subtitle': return ({required Object count}) => '${count} questions · All previous parts';
			...
			case 'smart_hearts_guide_title': return 'Playing with lives';
			case 'smart_hearts_guide_body': return 'Each wrong answer costs a heart ❤️. Lose all 3 and you\'ll be taken back — complete the earlier parts to unlock the full exam.';
			case 'smart_hearts_guide_got_it': return 'Got it';
			...
			case 'smart_result_failed': return 'Not quite — try again';
			case 'smart_result_weak_updated': return ({required Object count}) => '${count} weak questions updated';
			case 'smart_result_continue': return 'Continue';
			case 'smart_no_exams': return 'No exams available for Smart Learning yet';
			...
			case 'smart_category_exam': return 'exam';
			case 'smart_category_exams': return 'exams';
			case 'smart_category_mistakes_subtitle': return ({required Object count, required Object questionLabel}) => '${count} ${questionLabel} to review across this category';
			case 'smart_category_question': return 'question';
			case 'smart_category_questions': return 'questions';
			case 'smart_result_unlock_needed': return ({required Object count}) => 'Master ${count} questions to unlock the full exam.';
			case 'smart_result_unlock_remaining': return ({required Object count, required Object questionLabel}) => '${count} more ${questionLabel} to master and you\'ll unlock the full exam.';
			case 'smart_result_part_passed_caps': return 'PART PASSED';
			case 'smart_result_try_again_caps': return 'TRY AGAIN';
			case 'smart_result_overall_mastery': return 'Overall Mastery';
			case 'smart_result_threshold': return '70% to pass';
			case 'smart_mastered_of': return ({required Object mastered, required Object total}) => '${mastered} / ${total} mastered';
			case 'smart_in_a_row': return ({required Object n}) => '${n} in a row';
			case 'smart_exit_title': return 'Leave Smart Learning?';
			case 'smart_exit_body': return 'Your current session progress will be lost.';
			case 'smart_feedback_correct': return 'Correct!';
			case 'smart_feedback_incorrect': return 'Incorrect';
			case 'smart_feedback_correct_answer': return 'Correct Answer:';
			default: return null;
		}
	}
}
